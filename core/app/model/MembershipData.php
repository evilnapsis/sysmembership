<?php
class MembershipData extends Extra {
	public static $tablename = "membership";
	public $extra_fields;
	public $extra_fields_strings;

	public $id, $name, $description, $duration, $price, $created_at;
	...
	public static function getById($id){
		...
		return Model::one($query[0],new MembershipData());
	}
	...
	public static function getAll(){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new MembershipData());
	}
