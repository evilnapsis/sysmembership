<?php
class ContractData extends Extra {
	public static $tablename = "contract";
	public $extra_fields;
	public $extra_fields_strings;

	public $id, $client_id, $membership_id, $user_id, $start_at, $finish_at, $status, $created_at;
	...
	public static function getById($id){
		...
		return Model::one($query[0],new ContractData());
	}
	...
	public static function getAll(){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new ContractData());
	}
