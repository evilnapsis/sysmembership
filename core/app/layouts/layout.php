...
<html lang="en">
  <head>
    ...
    <title>SysMembership  - Evilnapsis</title>
...
<h4><a href="./" style="color: white;"><b>SysMembership</b></a></h4>

</div>
<div class="sidebar-brand-narrow" width="46" height="46" alt="CoreUI Logo">
<h4><a href="./" style="color: white;"><b>SM</b></a></h4>
      ...
      <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        ...
        <li class="nav-item"><a class="nav-link" href="./?view=control&opt=all">
            <svg class="nav-icon">
              <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-description"></use>
            </svg> Control de Acceso</a></li>
            <li class="nav-item"><a class="nav-link" href="./?view=contracts&opt=all">
            <svg class="nav-icon">
              <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-description"></use>
            </svg> Contratos</a></li>
        ...
        <li class="nav-item"><a class="nav-link" href="./?view=memberships&opt=all">
            <svg class="nav-icon">
              <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-credit-card"></use>
            </svg> Membresias</a></li>

        <li class="nav-item"><a class="nav-link" href="./?view=payments&opt=all">
            <svg class="nav-icon">
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
          ...
          <ul class="nav-group-items">
            <li class="nav-item"><a class="nav-link" href="./?view=contractsreport"><span class="nav-icon"></span> Reporte de Contratos</a></li>
            <li class="nav-item"><a class="nav-link" href="./?view=paymentsreport"><span class="nav-icon"></span> Reporte de Pagos</a></li>
            <li class="nav-item"><a class="nav-link" href="./?view=controlreport"><span class="nav-icon"></span> Reporte de Accesos</a></li>
          </ul>
        </li>
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            <svg class="nav-icon">
    ...
    <div class="wrapper d-flex flex-column min-vh-100 bg-light">
      ...
      <footer class="footer">
        ...
        <div class="ms-auto">Version <b>1.1</b></div> 
      </footer>
    </div>
    <?php endif; ?>
